...
//   const [hasSynced, setHasSynced] = useState(false); // 🆕 Prevent double sync on re-renders
...
//     if (isLoggedIn && user) {
//       if (!hasSynced) {
//         syncGuestCartToServer(); // 🔄 Only once
//       } else {
//         fetchServerCart(); // Subsequent cart loads
//       }
//     } else {
//       setCartLoading(false); // guest
//     }
...
//       fetchServerCart();
//     } catch (err) {
//       console.error("Error syncing guest cart:", err.message);
//       fetchServerCart(); // fallback
//     }
//   };
...
//       try {
//         await axios.delete(
//           `${globalBackendRoute}/api/cart/remove/${productId}`,
//           {
//             headers: {
//               Authorization: `Bearer ${localStorage.getItem("token")}`,
//             },
